...
class Pagination
{
     ...
     * @param $perpage int number of records per page
     * @param $total int total number of entries
     */
    ...
    /**
     * Function returns ready html code
     * @return mixed
     */
    ...
    /**
     * Function returns the total number of pages
     * @return int
     */
